...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("delegate", "Create a Kanban task assigned to a specialist profile",
               "Tools & Skills", args_hint="<profile> <task>"),
    CommandDef("team", "Show team/Kanban status, queue, assignees, or stats",
               "Tools & Skills", args_hint="[status|queue|assignees|stats]",
               subcommands=("status", "queue", "assignees", "stats")),
